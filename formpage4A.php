...
?>
<?php session_start();
$_SESSION['subject']="Applied-physics IV"; ?>
<html>
<head>
    ...
    <body>
     <pre>	   <a href="formpage4A.php?logout='1'" style="color: red;">logout</a> </pre>
	<form method="post" action="formpage4A.php">
