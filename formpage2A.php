...
?>
<pre>                       <strong><?php include('errors.php'); ?></strong></pre>
<?php session_start();
$_SESSION['subject']="Applied-mathematics II"; ?>
<html>
<head>
    ...
    <body>
    <pre>	   <a href="formpage2A.php?logout='1'" style="color: red;">logout</a> </pre>
	<form method="post" action="formpage2A.php">
    ...
    <h3 class="a">Thank you for taking this survey. Your input is extremely valuable. The information that we are collecting using this survey will be used solely for the purpose of evaluating and improving the delivery of this course.</h3><br><br>
        ...
        <tr>
            ...
            <td>Year/Semester</td>
                <td>
                <input type="text" name="sem" value=<?php if($_SESSION['sem'] == 's2'){ echo "SEMESTER2"; } ?> >
                </td>
            </tr>
        </table><br><br>
        <h3>
