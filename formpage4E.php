...
?>
<?php session_start();
$_SESSION['subject']="Open source tech"; ?>
<html>
<head>
    ...
    <body>
    <pre>	   <a href="formpage4E.php?logout='1'" style="color: red;">logout</a> </pre>
	<form method="post" action="formpage4E.php">
