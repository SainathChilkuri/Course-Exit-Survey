...
?>
<?php session_start();
$_SESSION['subject']="Multi Media System"; ?>
<html>
<head>
    ...
    <body>
        <pre>	   <a href="formpage5c.php?logout='1'" style="color: red;">logout</a> </pre>
	<form method="post" action="formpage5c.php">
    ...
    <h3 class="a">Thank you for taking this survey. Your input is extremely valuable. The information that we are collecting using this survey will be used solely for the purpose of evaluating and improving the delivery of this course.</h3><br><br>
        ...
        <tr>
            ...
            <td>Year/Semester</td>
                <td>
                 <input type="text" name="sem" value=<?php if($_SESSION['sem'] == 's5'){ echo "SEMESTER5"; } ?> >
                </td>
            </tr>
        </table><br><br>
        <h3>
        ...
        1. Were you able to write programs using programming constructs                             <select name="ques">
                    <option value=""></option>
        ...
        2. Were you able to write programs using classes and objects                                    <select name="ques">
                    <option value=""></option>
                    <option value="4">4</option>
                    <option value="3">3</option>
                    <option value="2">2</option>
        ...
        3. Were you able to execute programs using strings, vectors and array.                      <select name="ques">
                    <option value=""></option>
                    <option value="4">4</option>
                    <option value="3">3</option>
                    <option value="2">2</option>
        ...
        4. Were you able to implement the concept of inheritance and interfaces.                     <select name="ques">
                    <option value=""></option>
                    <option value="4">4</option>
                    <option value="3">3</option>
                    <option value="2">2</option>
        ...
        5. Were you able to illustrate exception handling and multithreading in java.               <select name="ques">
                    <option value=""></option>
                    <option value="4">4</option>
                    <option value="3">3</option>
                    <option value="2">2</option>
